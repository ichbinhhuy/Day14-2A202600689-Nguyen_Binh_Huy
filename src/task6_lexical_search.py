...
def build_bm25_index(corpus: list[dict]):
    ...
    """
    # Tokenize đơn giản bằng cách tách từ khoảng trắng và chuyển chữ thường, kèm chuẩn hóa NFC
    tokenized_corpus = [unicodedata.normalize('NFC', doc["content"]).lower().split() for doc in corpus]
